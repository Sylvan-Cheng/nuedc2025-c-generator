...
from .placement import PlacementResult, place_c_exam_page
...
def generate_page(
    ...
    if noise_cfg.enable:
        ...
        export_noise_pngs(dwg, squares, page_cfg, export_cfg, noise_cfg, noise_font_folder)
...
def _generate_type(
    ...
    for i in range(1, type_cfg.total_files + 1):
        ...
        generate_page(page_cfg, result.squares, result.digits, filename, type_dir, digit_cfg.font_size, export_cfg, noise_cfg)
